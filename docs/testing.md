...
| --- | --- | --- | --- |
| C++ (`tests/cpp`) | 70 cases, ~19k assertions | C++20 compiler | yes |
| C++ under TSan / ASan / UBSan | same 70 | clang | yes, all three clean |
| Python (`tests/python`) | 182 | Python + PyTorch | yes |
